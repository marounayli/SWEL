...
admissions=find_elem({"tag":"a", "attrs":{}, "value" :"Our Clients"})
...
dossier = find_elem({"tag":"a", "attrs": {"href":"/banks/"}, "value":"Banks"})
...
time.sleep(3)
email = find_elem({"tag":"a", "attrs": {"name":"/case-studies"},"value":""})
